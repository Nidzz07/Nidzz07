<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=26&pause=1000&color=A855F7&center=true&vCenter=true&width=700&lines=Hi%2C+I'm+Nidhi+Dhyani+%F0%9F%91%8B;Full-Stack+%7C+AI+%2F+ML+Engineer;Building+Intelligent+%26+Scalable+Systems+%F0%9F%9A%80;Open+to+Collaborate!" alt="Typing SVG" />
</div>

<div align="center">
  <img src="https://komarev.com/ghpvc/?username=Nidzz07&style=flat-square&color=A855F7&label=Profile+Views" alt="Profile Views" />
  <img src="https://img.shields.io/github/followers/Nidzz07?style=flat-square&logo=github&label=Followers" alt="GitHub Followers" />
</div>

<br/>

I build across the **full stack** — from data pipelines and ML models to clean, deployable web interfaces. I care about code that's maintainable, systems that scale, and products that solve real problems.
...
| :--- | :--- | :--- |
| **[tailgating-detection-deepstream](https://github.com/Nidzz07/tailgating-detection-deepstream)** | This project implements a real-time video analytics system using NVIDIA DeepStream and the pre-trained DashcamNet model to detect tailgating behavior by processing driving video, detecting vehicles, and identifying unsafe following distances through bounding box analysis. | ![Python](https://img.shields.io/badge/-Python-black?logo=python) ![NVIDIA DeepStream](https://img.shields.io/badge/-NVIDIA%20DeepStream-black?logo=nvidia) ![GStreamer](https://img.shields.io/badge/-GStreamer-black?logo=gstreamer) ![OpenCV](https://img.shields.io/badge/-OpenCV-black?logo=opencv) ![Pandas](https://img.shields.io/badge/-Pandas-black?logo=pandas&logoColor=white) ![NumPy](https://img.shields.io/badge/-NumPy-black?logo=numpy&logoColor=white) ![Matplotlib](https://img.shields.io/badge/-Matplotlib-black) |
| **[titanic-survival-ml-pipeline](https://github.com/Nidzz07/titanic-survival-ml-pipeline)** | End-to-end machine learning pipeline for Titanic survival prediction involving preprocessing, feature engineering, model training, evaluation, and prediction workflow. | ![Python](https://img.shields.io/badge/-Python-black?logo=python) ![Pandas](https://img.shields.io/badge/-Pandas-black?logo=pandas&logoColor=white) ![NumPy](https://img.shields.io/badge/-NumPy-black?logo=numpy&logoColor=white) ![Scikit-Learn](https://img.shields.io/badge/-Scikit--Learn-black?logo=scikitlearn) ![XGBoost](https://img.shields.io/badge/-XGBoost-black) ![Seaborn](https://img.shields.io/badge/-Seaborn-black) |
...
- **End-to-end thinking** — from raw data to deployed product.
- **Clean systems** — readable code, documented repos, reproducible pipelines.
- **Always learning** — currently deepening expertise in DevOps, cloud, and LLMs.

---

<p align="center">
  <a href="mailto:nsdhyani22@gmail.com">
